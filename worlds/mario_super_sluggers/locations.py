...
LOCATION_NAME_TO_ID = {
    ...
    "Mario Stadium: Left barrel after Yellow Pianta": 0x80E55D5902,
...
def create_locations(world: MarioSuperSluggersWorld) -> None:
    ...
    mario.add_locations(get_location_names_with_ids([
        ...
        "Mario Stadium: Left barrel after Yellow Pianta",
    ...
    bowser_jr.add_event(
        "Bowser Castle: Defeat Bowser Monsters", "Victory", location_type=MarioSuperSluggersLocation,
